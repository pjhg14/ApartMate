...
public class TnantInfoController {
	...
	private void setText() {
		// Set Tenant Text
		nameText.setText(tenant.getFullName());
		addressText.setText(Database.getInstance().getCurrApt().getAddress());
		phoneText.setText(tenant.getPhone());
		emailText.setText(tenant.getEmail());
		SSNText.setText(tenant.getSSN());
		rentText.setText("" + tenant.getRent());
		try {
