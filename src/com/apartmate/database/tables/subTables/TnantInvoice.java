 ...
 */
public class TnantInvoice extends Table {
	...
	public TnantInvoice(int id, int fk, double paymentAmount, Date paymentDate, Date dueDate) {
		super(id, fk);
	...
	public TnantInvoice(int id, int fk, double paymentAmount, double balance, double totalPaid, double totalDue,
